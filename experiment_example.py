...
def classify_suggestions(suggList, relevant, maybe, p, n, rd):
...
def run_experiment(resultDir, actorId, actor, runs, rounds, numSuggs, numSegments,
    ...
    for r in range(runs):
        ...
        while(current_session_time < session_end_time):
            ...
            rd += 1
            # This if statement is used when the evaluation is simulating initial rounds without measurements
            # Essentially for learning modality weights from an "existing" session if possible
